...
WebElement chglocalnameElement=driver.findElement(By.id("updateLeadForm_firstNameLocal"));
chglocalnameElement.sendKeys("Geetha J");

driver.findElement(By.name("description")).clear();
WebElement descripElement=driver.findElement(By.id("updateLeadForm_description"));
descripElement.sendKeys("firstnamelocal has been edited successfully.Reqest processed");
